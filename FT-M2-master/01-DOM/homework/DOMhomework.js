...
span.innerHTML += " Silvina Navarro";
...
function buildToDos(toDos) {
  // Tu código acá:
  //todo = [{desc: "barrer", comp: false} {desc: "cocinar", comp: false} {desc: "limpiar", comp: false} {desc: "estudiar", comp: false} ]
...
function displayToDos() {
  // Tu código acá:
  // let toDoContainer = document.getElementById("toDoContainer"); // punto 1
  // toDoContainer.innerHTML = ""; // punto 2
  // let resultado = buildToDos(toDoItems); //punto 3
